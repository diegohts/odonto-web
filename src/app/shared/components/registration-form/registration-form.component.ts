...
import { CroValidator } from './validators/cro.validator';
...
export class RegistrationFormComponent implements OnInit, OnDestroy {
  ...
  private initForm(): void {
    this.registrationForm = this.formBuilder.group({
      ...
      cro: [
        ...
        [CroValidator.validator(this.doctorsService)],
      ],
      cpf: [
        '',
        [
    ...
    if (this.formOptions.type === 'patient') {
      this.registrationForm.get('cro')?.clearValidators();
      this.registrationForm.get('cro')?.clearAsyncValidators();
  ...
  private updateFormValues(): void {
    ...
    this.registrationForm.get('cro')?.disable();
  ...
  public get cro() {
    return this.registrationForm.get('cro');
  }
